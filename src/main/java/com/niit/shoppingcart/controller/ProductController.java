...
public class ProductController {
	...
	public ModelAndView display8() {
		ModelAndView m4 = new ModelAndView("anyuser");
		return m4;
	}
	...
	public String addBook(HttpServletRequest request,HttpSession session,@Valid @ModelAttribute("Product") Product product,BindingResult result) {
		if (result.hasErrors()) {
			return "addproduct";
		}
...
//			System.out.println(e.getMessage());
	...
	public ModelAndView display11() {
		ModelAndView m10 = new ModelAndView("viewproducts");
		return m10;
	}
...
//	public ModelAndView display111() {
//		ModelAndView m100 = new ModelAndView("AddSupplier");
//		return m100;
//	}
...
//	}
	 ...
	 @RequestMapping(value="updateproduct",method=RequestMethod.POST)
	    public ModelAndView updateProduct(HttpServletRequest request,HttpSession session,@Valid @ModelAttribute("Product")Product product,BindingResult result)
	    {
